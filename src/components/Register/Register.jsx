...
function Register() {
  ...
  return (
    ...
    <div className="  container  flex flex-col   mt-12 p-5 lg:ps-[25%]">
      ...
      <h1 className="mb-4  text-3xl font-bold text-gray-900  md:text-4xl lg:text-5xl"><span className="text-transparent bg-clip-text bg-gradient-to-r to-green-400 from-green-900">Register Now</span> </h1>
